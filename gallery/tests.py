...
class TestImage(TestCase):
    def setUp(self):
        ...
        self.category = Category(name='hello')
        self.category.save_category()

        self.image_test = Image(id=1, name='image', description='Django is interresting', location=self.location,
    ...
    def test_search_image_by_location(self):
        self.image_test.save_image()
        found_images = self.image_test.filter_by_location(location='kampala')
...
class TestLocation(TestCase):
    ...
    def test_update_location(self):
        ...
        changed_location = Location.objects.filter(name='kigali')
